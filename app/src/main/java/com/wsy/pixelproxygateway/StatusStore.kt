    ...
    private fun readStatusFromDisk(): RuntimeStatus? {
        ...
        return runCatching {
            ...
            RuntimeStatus(
                ...
                lastHttpProxyRequestOk = json.optBoolean("lastHttpProxyRequestOk", false),
                lastHttpProxyStatus = json.optInt("lastHttpProxyStatus", 0),
                lastHttpProxyError = json.optString("lastHttpProxyError", ""),
                lastSocksProxyRequestOk = json.optBoolean("lastSocksProxyRequestOk", false),
                lastSocksProxyStatus = json.optInt("lastSocksProxyStatus", 0),
                lastSocksProxyError = json.optString("lastSocksProxyError", ""),
                lastProxyRequestSummary = json.optString("lastProxyRequestSummary", ""),
